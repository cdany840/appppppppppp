    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          ...
          StreamBuilder(
            stream: FirebaseFirestore.instance.collection('nuevas').snapshots(),
                              ...
                              showDialog(
                                ...
                                builder: (BuildContext context) {
                                  return AlertDialog(
                                    ...
                                    content: const  Text("¿Estás seguro de que quieres aceptar esta cita?"),
                                    actions: [
                                      TextButton(
                                      ...
                                      TextButton(
                                        ...
                                        onPressed: () async {
                                          ...
                                          DocumentReference documentReference = FirebaseFirestore.instance.collection('nuevas').doc(newcitas[index].id);
                                          ...
                                          if (citaData != null) {
                                            ...
                                            await FirebaseFirestore.instance.collection('pendientes').add(citaData);
